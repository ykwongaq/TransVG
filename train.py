...
def get_args_parser():
    ...
    parser.add_argument(
        "--clip_max_norm", default=0.0, type=float, help="gradient clipping max norm"
    )
    parser.add_argument(
        "--eval",
        dest="eval",
    ...
    parser.add_argument(
        "--aug_crop", action="store_true", help="If true, use random crop augmentation"
    )
    parser.add_argument(
        "--aug_scale", action="store_true", help="If true, use multi-scale augmentation"
    )
    parser.add_argument(
        "--aug_translate",
        action="store_true",
    ...
    parser.add_argument(
        "--emb_size", default=512, type=int, help="fusion module embedding dimensions"
    )
    ...
    parser.add_argument(
        "--dataset", default="referit", type=str, help="referit/unc/unc+/gref/gref_umd"
    )
    parser.add_argument(
        "--max_query_len",
        default=20,
    ...
    parser.add_argument(
        "--detr_model",
        default="./saved_models/detr-r50.pth",
        type=str,
        help="detr model",
    )
    parser.add_argument(
        "--bert_model", default="bert-base-uncased", type=str, help="bert model"
    )
    parser.add_argument(
        "--light",
        dest="light",
...
def main(args):
    ...
    # build dataset
    dataset_train = build_dataset(args.train_split, args)
    dataset_val = build_dataset(args.val_split, args)
